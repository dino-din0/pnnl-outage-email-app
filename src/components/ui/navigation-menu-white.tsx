...
const navigationMenuTriggerStyle = cva(
  "IOS-white-bg inline-flex text-black items-center justify-center rounded-md text-sm font-normal transition-colors focus:outline-none focus:bg-slate-100 disabled:opacity-50 disabled:pointer-events-none bg-transparent hover:bg-whit  data-[active]:bg-white  h-10 py-2 px-4 group w-max"
)
