...
const navigationMenuTriggerStyle = cva(
  "IOS-white-bg bg-white inline-flex text-black items-center justify-center rounded-md text-sm font-normal transition-colors focus:outline-none focus:bg-slate-100 disabled:opacity-50 disabled:pointer-events-none bg-transparent hover:bg-whit data-[state=open]:bg-white data-[active]:bg-white dark:data-[active]:bg-white h-10 py-2 px-4 group w-max"
)
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="bg-white relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
