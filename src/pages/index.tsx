...
export default function TestingPNNLEmails() {
  ...
  function convertToSuperscript(text: string): string {
    ...
    return text.replace(pattern, (match: string, month: string, day: string, suffix: string) => {
  ...
  function insertLineBreakAt(text: string, maxChars: number): string {
    ...
    return text.substring(0, breakPoint) + '<br></br>' + text.substring(breakPoint);
  }
  ...
  const handleExampleSubmission = () => {
    ...
    formFormEmail.setValue('questionAuthorities', formValues.questionAuthorities);
  ...
  return (
    <div className="bg-white h-fit py-12">
      <div className="container text-6xl font-bold text-center text-cws-dark pb-12">PNNL Outage Email App</div>
            ...
            <Form {...formFormEmail}>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="drop-shadow-xl text-2xl IOS-black">Title & Purpose</FormLabel>
                      <FormControl>
                        <Input placeholder="Title and purpose" {...field} className="bg-white drop-shadow-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="drop-shadow-xl text-2xl IOS-black">Why</FormLabel>
                      <FormControl>
                        <Input placeholder="Why statement" {...field} className="bg-white drop-shadow-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="drop-shadow-xl text-2xl IOS-black">When</FormLabel>
                      <FormControl>
                        <Input placeholder="When statement" {...field} className="bg-white drop-shadow-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="text-2xl IOS-black">Where/Affected Area</FormLabel>
                      <FormControl>
                        <Textarea
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="text-2xl IOS-black">Restrictions</FormLabel>
                      <FormControl>
                        <Textarea
                          className="max-h-48 h-24 bg-white drop-shadow-xl"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="text-2xl IOS-black">Notification Statement</FormLabel>
                      <FormControl>
                        <Textarea
                          className="max-h-48 h-24 bg-white drop-shadow-xl"
                ...
                <div className="flex gap-6 items-center h-fit mt-6">
                  ...
                  <Button
                    ...
                    className={`h-12 rounded-sm w-64 drop-shadow-2xl text-lg ${
                      copyFormSuccess ? 'bg-green-500 hover:bg-green-700' : 'bg-gray-600 hover:bg-gray-800'
                    }`}
                    type="button"
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-start mb-auto drop-shadow-xl rounded reounded-lg px-10 gap-12">
          <div className="flex flex-col">
            <div className="flex flex-col gap-2">
              <div className="text-start flex text-3xl font-semi-bold text-decoration underline">How to Use</div>
              <div className="text-start flex text-lg">
                Welcome to the PNNL Outage Email App! Follow these simple steps:
              </div>
              <ol className="text-start flex flex-col gap-1 text-lg list-disc list-inside">
                <li>Fill in the input fields to create your outage notification.</li>
                <li>Click 'Submit' to generate your email template. You can then copy it for use.</li>
                <li>
                  Paste bulk emails into the 'Bulk Emails' field. Our tool will automatically remove any duplicates and
                  format them correctly. Then, copy the emails to clipbaord and use in outage notification email.
                </li>
                <li>
                  For an example, hit the 'Show Example' button below and then 'Submit', and see how a filled form looks
                  down below!
                </li>
              </ol>
              <Button
            ...
            <Form {...formEmail}>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      <FormLabel className="text-2xl IOS-black font-semibold">Bulk Emails</FormLabel>
                      <FormControl>
                        <Textarea
                          className="max-h-48 h-24 bg-white drop-shadow-xl"
                ...
                <div className="flex gap-12">
                  <Button
                    className={`h-12 rounded-sm w-48 drop-shadow-2xl text-lg hover:bg-[#5a0b0d] fade-bg-transition ${
                      submissionEmailFeedback ? 'bg-green-600 hover:bg-green-600' : 'bg-[#911a1d]'
                    }`}
                    type="submit"
                  >
                  ...
                  <Button
                    ...
                    className={`h-12 rounded-sm w-64 drop-shadow-2xl text-lg ${
                      copySuccess ? 'bg-green-500 hover:bg-green-700' : 'bg-gray-600 hover:bg-gray-800'
                    }`}
                    type="button"
      ...
      <div className="py-20 flex flex-col w-full h-full z-10 text-center items-center border-0 borderless contactSection">
        <div ref={contentRef} className="flex w-full flex-col text-center items-center">
          ...
          >
            ...
            >
              <span dangerouslySetInnerHTML={{ __html: formValues.when }} />
            </strong>
          </p>
          ...
          >
            As a general safety reminder, we ask that you be cognizant of the work activities and be sure to stay clear
            of all posted/barricaded areas.
          </p>
            ...
            <table className="table-auto w-full text-left">
              <thead>
                <tr className="bg-gray-200 text-center">
                  <th className="px-4 py-2 border-2 border-black text-center">Name</th>
                  <th className="px-4 py-2 border-2 border-black text-center">Phone</th>
                  <th className="px-4 py-2 border-2 border-black text-center">Cell</th>
                  <th className="px-4 py-2 border-2 border-black text-center">Role</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="px-4 py-2 border-2 border-black text-center">Tony James</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-375-6456</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-521-2368</td>
                  <td className="px-4 py-2 border-2 border-black text-center">Building Engineer</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 border-2 border-black text-center">Robert McKinney</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-375-7561</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-592-1037</td>
                  <td className="px-4 py-2 border-2 border-black text-center">Facility Services Specialist</td>
                </tr>
                <tr>
                  <td className="px-4 py-2 border-2 border-black text-center">Sandra Fies</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-372-6737</td>
                  <td className="px-4 py-2 border-2 border-black text-center">509-554-4854</td>
                  <td className="px-4 py-2 border-2 border-black text-center">Building Manager</td>
                </tr>
              </tbody>
            </table>
          </div>
